	...
	public List<Country> loadCountries(int cityId){
		...
		if(cursor.moveToFirst()){
			do{
				...
				list.add(country);
				//bug了2天！！！！！！操！！！落了把listadd进去了！！！
				Log.i("zzh", "设置countryList一次");
			}while(cursor.moveToNext());
		}
		if(cursor!=null){
			cursor.close();
